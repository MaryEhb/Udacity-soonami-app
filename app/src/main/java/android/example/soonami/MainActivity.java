        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if(urlConnection.getResponseCode() == 200){
                    ...
                    Log.e(LOG_TAG, "problem in getting inputStream, error respond code : " + urlConnection.getResponseCode());
                }

            } catch (IOException e) {
                // TODO: Handle the exception
                Log.e(LOG_TAG, "problem in getting results check your internet connection",e);
